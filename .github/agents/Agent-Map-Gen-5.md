...
- Target: `workspace/deliverables/generated/api-mapping.md`
...
- Step: 5 of 7 (API Mapping + Coverage).
...
- If prerequisites are missing, stop and ask the user to run `Agent-BC-Gen-4` then `Agent-BC-Judge-4` and `Agent-Gherkin-Gen-3` then `Agent-Gherkin-Judge-3`.
