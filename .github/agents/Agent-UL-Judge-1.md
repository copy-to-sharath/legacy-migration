...
- Description: Copilot chat participant for ubiquitous language (judge).
- Role: `judge`
...
- Step: 1 of 7 (Ubiquitous Language review).
- Prerequisite deliverable must exist before running this step:
  - `workspace/deliverables/generated/ubiquitous-language.md`
- If the deliverable is missing, stop and ask the user to run `Agent-UL-Gen-1`.
