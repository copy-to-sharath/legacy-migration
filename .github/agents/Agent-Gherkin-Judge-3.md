...
- Verify the Generator used prior deliverables as inputs:
  - `workspace/deliverables/generated/brd.md`
  - `workspace/deliverables/generated/ubiquitous-language.md`
- Verify both artifacts were produced and reviewed:
...
- Step: 3 of 7 (Gherkin + Tests review).
- Prerequisite deliverables must exist before running this step:
  - `workspace/deliverables/generated/features/*.feature`
  - `workspace/deliverables/generated/tests/`
  - `workspace/deliverables/generated/brd.md`
  - `workspace/deliverables/generated/ubiquitous-language.md`
- If feature or test outputs are missing, stop and ask the user to run `Agent-Gherkin-Gen-3`.
- If BRD is missing, stop and ask the user to run `Agent-BRD-Gen-2`.
- If Ubiquitous Language is missing, stop and ask the user to run `Agent-UL-Gen-1`.
