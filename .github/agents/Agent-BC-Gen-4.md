...
- Description: Copilot chat participant for bounded-contexts (generator).
- Role: `generator`
- Deliverable: `bounded-contexts`
- Template: `workspace/prompts/bounded-contexts-template.md`
- Target: `workspace/deliverables/generated/bounded-contexts.md`
...
- Step: 4 of 7 (Bounded Contexts + DDD).
...
- If `brd.md` is missing, stop and ask the user to run `Agent-BRD-Gen-2` then `Agent-BRD-Judge-2`.
- If `ubiquitous-language.md` is missing, stop and ask the user to run `Agent-UL-Gen-1` then `Agent-UL-Judge-1`.
- If Gherkin artifacts are missing, stop and ask the user to run `Agent-Gherkin-Gen-3` then `Agent-Gherkin-Judge-3`.
